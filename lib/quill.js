...
EventEmitter2 = require('eventemitter2').EventEmitter2 || require('eventemitter2');
...
Quill = (function(_super) {
  ...
  function Quill(container, options) {
    ...
    this.options.id = this.id = "quill-" + Quill.nextId;
    Quill.nextId += 1;
  ...
  Quill.prototype.destroy = function() {
    ...
    return this.emit(Quill.events.DESTROY);
  };
